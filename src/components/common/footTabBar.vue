...
<div>
  ...
  <mt-tab-item id="tab3" v-bind:class="{active:selected=='friends'}" @click.native="setTab('friends')">
  ...
  <mt-tab-item id="tab4" v-bind:class="{active:selected=='account'}" @click.native="setTab('account')">
